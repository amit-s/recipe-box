...
export default class RecipeForm extends React.Component{
	render(){
		...
		return(
			<div>
				<div>Recipe Name</div>
				<input ref="newName" onClick={(e)=>e.stopPropagation()} defaultValue={defaultName}/>
				<div>Ingredients</div>
				<textarea ref="newIngredients" onClick={(e)=>e.stopPropagation()} defaultValue={defaultIngredients}></textarea><br />
